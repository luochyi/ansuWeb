    ...
    <div>
        ...
        <el-row class="box">
            <el-row style="display:flex;align-items:center;margin-bottom:20px">
                ...
                <el-row>
                    <el-row>
                        <span class="headerTitle">出库出仓</span>
                        <span class="item-info"></span>
                    </el-row>
                    <el-row style="margin-top:10px">
                        <el-col :span="8">
                ...
                <el-row>
                    ...
                    <el-row style="margin-top:10px">
                      ...
                      <el-row style="margin-bottom:8px">
                        <el-col :span="8">
                            <span class="item1">提单号：</span>
                            <span class="item2"></span>
                            <el-button type="text" style="padding:0">修改</el-button>
                        </el-col>
                      </el-row>
                      <el-row style="margin-bottom:8px">
                        <el-col :span="8">
                            <span class="item1">运输轨迹：</span>
                            <span class="item2"></span>
                      ...
                      <el-row style="margin-bottom:8px">
                        <el-col :span="8">
                            <span class="item1">签收单：</span>
                            <span class="item2"></span>
                            <el-button type="text" style="padding:0" @click="receiptForm">修改：</el-button>
                        </el-col>
                      </el-row>
                    </el-row>
                </el-row>
                ...
                <el-row>
                    ...
                    <el-row style="margin-top:10px">
                        <el-col :span="8">
                            <span class="item1">FBA23534535（002-004）</span>
                            <span class="item2"></span>
        ...
        <el-dialog
          title="签收单"
          :visible.sync="dialogReceiptForm"
          top="12%"
          width="30%">
          <div class="line" style="margin-top:-20px;margin-bottom:40px"></div>
          <el-row style="text-align:left">
            <span class="receiptForm">签收单</span>
            <div style="display:flex;">
              ...
              <div style="margin-top:34px;margin-left:10px">
                <el-button type="text">修改</el-button>
                <el-button type="text" style="color: #FF0003">删除</el-button>
              </div>
            </div>
          </el-row>
          <span slot="footer" class="dialog-footer">
              <el-row class="line"></el-row>
              <el-button class="wuBtn" @click="dialogReceiptForm = false" size="small">取 消</el-button>
              <el-button class="orangeBtn" @click="dialogReceiptForm = false" size="small">确 定</el-button>
          </span>
        </el-dialog>
        <el-drawer
