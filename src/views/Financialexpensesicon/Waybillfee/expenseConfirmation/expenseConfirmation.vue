  ...
  data () {
    return {
      ...
      columns: [
        ...
        { prop: 'channel_name', label: '预报渠道', width: '200', align: 'center' },
        { prop: 'channel_cate', label: '运输方式', width: '120', align: 'center', formatter: this.formatter },
        ...
        { prop: 'have_safe', label: '是否保险', width: '120', align: 'center', formatter: this.formatter }
      ],
      tableData: [],
      page: {
        pageNo: 1,
