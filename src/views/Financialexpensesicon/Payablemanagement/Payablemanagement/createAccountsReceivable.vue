    ...
    <div class="main">
      <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column>
              ...
              <el-table-column label="货物件数"></el-table-column>
          </el-table-column>
      </el-table>
    </div>
  </div>
