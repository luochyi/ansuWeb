  ...
  <div>
    <div class='main'>
      ...
      <el-row type='flex' justify='flex-start' class='title' align='middle'>
        <span class='text' style="height:50px;line-height:50px">追加费用</span>
      </el-row>
      <!-- 主要内容 -->
      <div class='content'>
        <el-row :gutter="15">
...
export default {
  ...
  methods: {
    getData () {
      ...
      this.$api.cost.price.additional.lists(params).then(res => {
    ...
    detail (id) {
      this.$router.push({ name: 'addFeeDetail', params: { waybillId: id } })
    },
