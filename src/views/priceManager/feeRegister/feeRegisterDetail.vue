  ...
  <div>
    <div class="box">
      ...
      <el-descriptions :column="4">
        ...
        <el-descriptions-item label="代理渠道">{{
        ...
        <el-descriptions-item label="代理体积">{{
          detailData.agent_volume
        }}</el-descriptions-item>
    ...
    <div class="box">
      ...
      <el-row style="line-height: 50px; font-size: 14px">
        <el-col :span="4"
          ><span style="color: #fb4702">合计应收：</span
          >{{ detailData.amount_info.receivable }}元</el-col
        >
        <el-col :span="4"
          ><span style="color: #fb4702">合计应付：</span
          >{{ detailData.amount_info.account_payable }}元</el-col
        >
        <el-col :span="4"
          ><span style="color: #fb4702">合计利润：</span
          >{{
            detailData.amount_info.receivable -
            detailData.amount_info.account_payable
          }}元</el-col
        >
      </el-row>
    </div>
